class Heap
  ...
  def has_greater_child(index)
    data[left_child_index(index)] && data[right_child_index(index)] > data[index] ||
     data[right_child_index(index)] && data[left_child_index(index)] > data[index]
  end

  def calculate_larger_child_index(index)
    return left_child_index(index) unless data[right_child_index(index)]
    return right_child_index(index) unl
  end
end